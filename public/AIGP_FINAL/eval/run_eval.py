...
def run_rec_eval(model_url: str) -> dict:
    ...
    test_data = {
        "00000000-0000-0000-0000-000000000001": {"978-1", "978-2", "978-3"},
        "00000000-0000-0000-0000-000000000002": {"978-4", "978-5"},
        "00000000-0000-0000-0000-000000000003": {"978-6", "978-7", "978-8"},
    }

    def model_fn(user_id: str):
