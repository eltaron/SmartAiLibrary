...
def _async_pinecone_mock(matches=None):
    mock = MagicMock()
    mock.query_global = AsyncMock(return_value=matches or [])
    return mock
...
class TestSearchEndpoint:
    ...
    def test_search_returns_top_k_results(self, mock_redis, mock_pc, mock_reranker, mock_encoder):
        ...
        mock_pc.query_global = AsyncMock(return_value=[
...
class TestSimilarEndpoint:
    ...
    def test_similar_returns_results(self, mock_redis, mock_cbf):
        ...
        mock_cbf.return_value.similar_books = AsyncMock(return_value=[
