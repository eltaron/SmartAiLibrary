...
async def run_retrain():
    ...
    with open("/tmp/interactions.json", "w", encoding="utf-8") as f:
    ...
    result = await asyncio.to_thread(
        ...
        [
            ...
            "--epochs", "10",
            "--output-path", settings.NCF_MODEL_PATH,
            "--mappings-path", settings.NCF_MAPPINGS_PATH,
    ...
    if precision >= 0.42:
        ...
        try:
            import mlflow
            mlflow.register_model(settings.NCF_MODEL_PATH, "ncf_production")
